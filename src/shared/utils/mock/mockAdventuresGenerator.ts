...
import type { Adventure } from "#app/modules/adventures/port/adventure.types.js";

const DIFFICULTIES: Adventure["difficulty"][] = [
  "Beginner",
  "Moderate",
  "Advanced",
];
...
export function generateAdventures(count = 10): Adventure[] {
  return Array.from({ length: count }).map((_, i) => {
    ...
    const included = faker.helpers.arrayElements(
      INCLUDED,
